...
const HamiltonHardscaping: React.FC = () => {
  ...
  useEffect(() => {
    if (sessionStorage.getItem('hamiltonHardscapingFormSubmitted')) {
      setShowThankYouMessage(true);
      sessionStorage.removeItem('hamiltonHardscapingFormSubmitted');
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        sessionStorage.setItem('hamiltonHardscapingFormSubmitted', 'true');
  ...
  const hamiltonProjects: Project[] = [
    ...
    },
    {
      ...
      alt: "Functional garden wall building"
    },
    {
      title: "Practical Pathways",
      after: "/pathway-HSC-Monoblock.webp",
      alt: "Durable pathway installation"
    }
  ];
  ...
  const whyChooseUs = [
    {
      ...
      title: "Hamilton's Trusted Experts",
      description: "Over 16 years serving Hamilton families with practical hardscaping solutions that provide excellent value and long-lasting performance."
    },
    {
      icon: <Shield className="w-6 h-6 text-primary-accent" />,
      title: "Built for Family Life",
      description: "Hardscaping designed for busy households with children and pets, using materials that withstand heavy daily use and Scottish weather."
    },
    {
  ...
  const faqs = [
    {
      question: "What's the best hardscaping option for Hamilton families?",
      answer: "For Hamilton's busy family homes, we recommend block paving or concrete for durability and value. These materials handle heavy use from children's play and multiple vehicles while providing excellent long-term performance."
    },
    {
      question: "How do you work around Hamilton's residential areas?",
      answer: "We coordinate with residents and provide efficient installation with minimal disruption. Our team understands Hamilton's diverse neighborhoods and works respectfully in all residential settings."
    },
    {
      question: "What's a realistic budget for Hamilton hardscaping?",
      answer: "Hamilton hardscaping typically ranges from £3,000-£10,000 depending on scope and materials. We provide honest, detailed quotes with practical options to fit different family budgets."
    },
    {
      question: "Do you work with Hamilton's varied property styles?",
      answer: "Yes, from Victorian terraces to modern estates, we adapt our hardscaping approach to suit each property type while ensuring proper drainage and functionality for your specific needs."
    },
    {
      question: "How do you ensure child and pet safety?",
      answer: "We use non-slip surfaces, rounded edges where appropriate, and child-safe materials throughout. Our installations prioritize family safety while maintaining durability and appeal."
    }
  ];
    ...
    <div className="min-h-screen bg-primary-bg text-text-primary">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh] pt-16 sm:pt-8 lg:pt-0">
            ...
            <div className="text-left mt-20 sm:mt-12 lg:mt-0">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-normal mb-6 text-white leading-relaxed" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
                Family-friendly patios, driveways & hardscaping built for busy Hamilton households.
              </h2>
              ...
              <p className="text-lg sm:text-xl text-white mb-8 max-w-xl leading-relaxed font-light" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
                Serving Hamilton families for 17+ years with honest value and installations that work as hard as you do.
              </p>
            ...
            <div className="hidden lg:block bg-black bg-opacity-60 backdrop-blur-sm rounded-xl p-8 border border-white border-opacity-10">
              ...
              <p className="text-gray-300 text-center mb-8">
                Tell us about your Hamilton hardscaping project
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <textarea
                    ...
                    placeholder="Tell us about your Hamilton hardscaping project..."
                  ></textarea>
                </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary-bg">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-6">
            Practical Hardscaping Services in Hamilton
          </h2>
          <div className="space-y-6 text-lg sm:text-xl text-text-secondary leading-relaxed">
            <p>
              Hamilton families need hardscaping that works for real life — durable patios for family gatherings, reliable driveways for busy households, and practical solutions that enhance your property without breaking the budget.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-secondary max-w-3xl mx-auto">
              Practical hardscaping solutions and reliable service that Hamilton homeowners have trusted for over 17 years.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary-bg">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-secondary max-w-3xl mx-auto">
              See how we've transformed outdoor spaces with professional hardscaping, quality materials, and expert craftsmanship.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-4">
              Hardscaping FAQs for Hamilton Residents
            </h2>
            <p className="text-lg text-text-secondary">
              Common questions about our practical hardscaping services for Hamilton families.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-accent/10 to-hover-accent/10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-secondary-bg/80 backdrop-blur-sm border border-primary-accent/30 rounded-xl p-8 lg:p-12">
            <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-6">
              Transform Your Hamilton Outdoor Space Today
            </h2>
            <p className="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
              Ready to create practical, beautiful hardscaping for your Hamilton home? Get your free consultation today.
            </p>
            ...
            <div className="mt-8 pt-6 border-t border-border-color">
              <p className="text-text-secondary text-sm">
                <strong className="text-primary-accent">Serving Hamilton:</strong> Practical hardscaping services for South Lanarkshire families
              </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "HSC Builders - Hardscaping Services Hamilton",
            "description": "Family-friendly hardscaping services in Hamilton, South Lanarkshire. Practical patios, driveways, and outdoor solutions for busy households.",
            "url": "https://hscbuilders.co.uk/areas/hamilton-hardscaping",
            ...
            "serviceType": "Family Hardscaping Services",
            "priceRange": "££",
            "aggregateRating": {
...
export default HamiltonHardscaping;