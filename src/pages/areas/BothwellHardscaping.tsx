...
const BothwellHardscaping: React.FC = () => {
  const [showThankYouMessage, setShowThankYouMessage] = useState(false);
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [openFAQ, setOpenFAQ] = useState<number | null>(null);

  useEffect(() => {
    if (sessionStorage.getItem('bothwellHardscapingFormSubmitted')) {
      setShowThankYouMessage(true);
      sessionStorage.removeItem('bothwellHardscapingFormSubmitted');
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      formData.append('service', 'Hardscaping');
      ...
      if (response.ok) {
        sessionStorage.setItem('bothwellHardscapingFormSubmitted', 'true');
  ...
  const bothwellProjects: Project[] = [
    ...
    },
    {
      ...
      alt: "Luxury pathway installation"
    }
  ];
  ...
  const whyChooseUs = [
    {
      ...
      title: "Bothwell's Premium Specialists",
      description: "Over 16 years creating distinguished hardscaping that enhances Bothwell's prestigious properties and reflects the area's upscale character."
    },
    {
      icon: <Shield className="w-6 h-6 text-primary-accent" />,
      title: "Luxury Materials & Finishes",
      description: "Premium natural stone, high-grade materials, and meticulous finishing that meets Bothwell's exacting standards for quality."
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-primary-accent" />,
      title: "Property Value Enhancement",
      description: "Hardscaping designed to significantly enhance your Bothwell property's curb appeal and long-term investment value."
    },
    {
  ...
  const faqs = [
    {
      question: "What hardscaping materials suit Bothwell's prestigious properties?",
      answer: "For Bothwell's upscale homes, we recommend premium natural stone, high-grade block paving, or luxury concrete finishes. These materials provide exceptional durability while enhancing your property's distinguished character."
    },
    {
      question: "How do you ensure quality befitting Bothwell standards?",
      answer: "We use only premium materials, employ skilled craftsmen, and follow meticulous installation processes. Every detail from foundation work to final finishing is executed to the highest standards expected in Bothwell."
    },
    {
      question: "What's the typical investment for Bothwell hardscaping?",
      answer: "Premium hardscaping in Bothwell typically ranges from £8,000-£20,000+ depending on scope and materials. We provide detailed quotes that reflect the quality and craftsmanship your property deserves."
    },
    {
      question: "How do you work respectfully in Bothwell's residential areas?",
      answer: "We understand Bothwell's refined residential character. Our team works discreetly with professional equipment, maintains immaculate sites, and coordinates carefully to minimize any impact on the neighborhood."
    },
    {
      question: "Do you handle planning permissions for Bothwell properties?",
      answer: "Yes, we assist with any required permissions and ensure full compliance with South Lanarkshire planning guidelines. Our experience with Bothwell properties means we understand local requirements thoroughly."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-primary-bg text-text-primary">
      <SEO
        title="Hardscaping Bothwell | Patios, Driveways & Retaining Walls"
        description="Expert hardscaping in Bothwell. Driveways, block paving, patios, retaining walls, pathways & steps. Quality installations in Bothwell & South Lanarkshire. Free quotes."
        keywords="hardscaping Bothwell, patios Bothwell, driveways Bothwell, retaining walls Bothwell, block paving Bothwell"
      />
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh] pt-16 sm:pt-8 lg:pt-0">
            ...
            <div className="text-left mt-20 sm:mt-12 lg:mt-0">
              <h1 className="font-body text-4xl sm:text-6xl lg:text-7xl font-semibold leading-tight mb-6 text-white" style={{ textShadow: '4px 4px 12px rgba(0,0,0,1), 2px 2px 6px rgba(0,0,0,0.9)' }}>
                Looking for Hardscaping Services in Bothwell?
              </h1>
              ...
              <p className="text-xl sm:text-2xl text-white/90 mb-8 max-w-2xl leading-relaxed font-light" style={{ textShadow: '2px 2px 6px rgba(0,0,0,0.9)' }}>
                From driveways to block paving, retaining walls to pathways — covering Bothwell & surrounding areas.
              </p>
            ...
            <div className="hidden lg:block bg-black bg-opacity-60 backdrop-blur-sm rounded-xl p-8 border border-white border-opacity-10">
              ...
              <p className="text-gray-300 text-center mb-8">
                Tell us about your Bothwell hardscaping project
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <textarea
                    ...
                    placeholder="Tell us about your Bothwell hardscaping project..."
                  ></textarea>
                </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary-bg">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-6">
            Premium Hardscaping Services in Bothwell
          </h2>
          <div className="space-y-6 text-lg sm:text-xl text-text-secondary leading-relaxed">
            <p>
              Bothwell's distinguished properties deserve hardscaping that reflects the area's prestigious character and enhances long-term property value. We create elegant outdoor spaces using premium materials and expert craftsmanship that complement your home's architectural distinction.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-secondary max-w-3xl mx-auto">
              Premium hardscaping installation and exceptional service that Bothwell residents have trusted for over 17 years.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary-bg">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-secondary max-w-3xl mx-auto">
              See how we've transformed outdoor spaces with professional hardscaping, premium materials, and expert craftsmanship.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-4">
              Hardscaping FAQs for Bothwell Residents
            </h2>
            <p className="text-lg text-text-secondary">
              Common questions about our premium hardscaping services for Bothwell properties.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-accent/10 to-hover-accent/10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-secondary-bg/80 backdrop-blur-sm border border-primary-accent/30 rounded-xl p-8 lg:p-12">
            <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-6">
              Transform Your Bothwell Outdoor Space Today
            </h2>
            <p className="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
              Ready to enhance your Bothwell property with premium hardscaping? Get your free consultation today.
            </p>
            ...
            <div className="mt-8 pt-6 border-t border-border-color">
              <p className="text-text-secondary text-sm">
                <strong className="text-primary-accent">Serving Bothwell:</strong> Premium hardscaping services for South Lanarkshire's finest properties
              </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "HSC Builders - Hardscaping Services Bothwell",
            "description": "Premium hardscaping services in Bothwell, South Lanarkshire. Luxury patios, driveways, and stonework for prestigious properties.",
            "url": "https://hscbuilders.co.uk/areas/bothwell-hardscaping",
            ...
            "serviceType": "Premium Hardscaping Services",
            "priceRange": "£££",
            "aggregateRating": {
...
export default BothwellHardscaping;