...
const NewtonFarmHardscaping: React.FC = () => {
  ...
  useEffect(() => {
    if (sessionStorage.getItem('newtonFarmHardscapingFormSubmitted')) {
      setShowThankYouMessage(true);
      sessionStorage.removeItem('newtonFarmHardscapingFormSubmitted');
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        sessionStorage.setItem('newtonFarmHardscapingFormSubmitted', 'true');
  ...
  const newtonFarmProjects: Project[] = [
    ...
    {
      title: "Modern Garden Walls",
      after: "/HSC-wall-Glasgow-landscaping.webp",
      alt: "Contemporary wall construction"
    },
    {
      title: "Sleek Pathway Design",
      after: "/pathway-HSC-Monoblock.webp",
      alt: "Modern pathway installation"
    }
  ];
  ...
  const whyChooseUs = [
    {
      ...
      description: "Over 16 years creating contemporary hardscaping that perfectly complements Newton Farm's modern development and architectural vision."
    },
    {
      icon: <Shield className="w-6 h-6 text-primary-accent" />,
      title: "Modern Design Expertise",
      description: "We understand Newton Farm's contemporary aesthetic and create hardscaping that enhances the area's modern architectural style."
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-primary-accent" />,
      title: "Smart Investment Value",
      description: "Hardscaping designed to maximize your Newton Farm property's potential and appeal in this desirable development area."
    },
    {
  ...
  const faqs = [
    {
      question: "What hardscaping suits Newton Farm's modern homes?",
      answer: "Newton Farm's contemporary properties work beautifully with clean-lined hardscaping, modern materials, and sleek designs. We focus on contemporary aesthetics that complement the development's architectural style."
    },
    {
    ...
    },
    {
      ...
      answer: "Newton Farm residents love contemporary block paving, sleek patio designs, and modern hardscaping features that match their homes' clean, contemporary aesthetic."
    },
    {
      question: "Do you understand Newton Farm's drainage requirements?",
      answer: "Yes, we're familiar with the local drainage characteristics in Newton Farm. Our installations account for these conditions to ensure proper water management and long-term durability."
    },
    {
      question: "How quickly can you start hardscaping work in Newton Farm?",
      answer: "For Newton Farm residents, we typically can begin hardscaping projects within 1-3 weeks for smaller installations, and 3-5 weeks for complete outdoor transformations, depending on the season."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-primary-bg text-text-primary">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh] pt-16 sm:pt-8 lg:pt-0">
            ...
            <div className="text-left mt-20 sm:mt-12 lg:mt-0">
              <h1 className="font-body text-4xl sm:text-6xl lg:text-7xl font-semibold leading-tight mb-6 text-white" style={{ textShadow: '4px 4px 12px rgba(0,0,0,1), 2px 2px 6px rgba(0,0,0,0.9)' }}>
                Looking for Hardscaping Services in Newton Farm?
              </h1>
              ...
              <p className="text-xl sm:text-2xl text-white/90 mb-8 max-w-2xl leading-relaxed font-light" style={{ textShadow: '2px 2px 6px rgba(0,0,0,0.9)' }}>
                From driveways to block paving, retaining walls to pathways — covering Newton Farm & surrounding areas.
              </p>
            ...
            <div className="hidden lg:block bg-black bg-opacity-60 backdrop-blur-sm rounded-xl p-8 border border-white border-opacity-10">
              ...
              <p className="text-gray-300 text-center mb-8">
                Tell us about your Newton Farm hardscaping project
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <textarea
                    ...
                    placeholder="Tell us about your Newton Farm hardscaping project..."
                  ></textarea>
                </div>
      ...
      {/* About Hardscaping in Newton Farm */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary-bg">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-6">
            Contemporary Hardscaping Services in Newton Farm
          </h2>
          <div className="space-y-6 text-lg sm:text-xl text-text-secondary leading-relaxed">
            <p>
              Newton Farm's modern development deserves hardscaping that matches its contemporary vision and innovative design. We create sleek outdoor spaces that enhance the area's modern aesthetic while providing practical solutions for today's homeowners.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-secondary max-w-3xl mx-auto">
              Modern hardscaping expertise and innovative solutions that Newton Farm homeowners have trusted for over 17 years.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary-bg">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-secondary max-w-3xl mx-auto">
              See how we've transformed outdoor spaces with professional hardscaping, modern materials, and expert craftsmanship.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-4">
              Hardscaping FAQs for Newton Farm Residents
            </h2>
            <p className="text-lg text-text-secondary">
              Common questions about our contemporary hardscaping services for Newton Farm properties.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-accent/10 to-hover-accent/10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-secondary-bg/80 backdrop-blur-sm border border-primary-accent/30 rounded-xl p-8 lg:p-12">
            <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-6">
              Transform Your Newton Farm Outdoor Space Today
            </h2>
            <p className="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
              Ready to create contemporary hardscaping that enhances your Newton Farm property? Get your free consultation today.
            </p>
            ...
            <div className="mt-8 pt-6 border-t border-border-color">
              <p className="text-text-secondary text-sm">
                <strong className="text-primary-accent">Serving Newton Farm:</strong> Contemporary hardscaping services for modern South Lanarkshire homes
              </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "HSC Builders - Hardscaping Services Newton Farm",
            "description": "Contemporary hardscaping services in Newton Farm, South Lanarkshire. Modern patios, driveways, and outdoor solutions for innovative homes.",
            "url": "https://hscbuilders.co.uk/areas/newton-farm-hardscaping",
            ...
            "serviceType": "Contemporary Hardscaping Services",
            "priceRange": "££",
            "aggregateRating": {
...
export default NewtonFarmHardscaping;