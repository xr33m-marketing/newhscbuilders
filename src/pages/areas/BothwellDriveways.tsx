...
const BothwellDriveways: React.FC = () => {
  ...
  useEffect(() => {
    if (sessionStorage.getItem('bothwellDrivewaysFormSubmitted')) {
      setShowThankYouMessage(true);
      sessionStorage.removeItem('bothwellDrivewaysFormSubmitted');
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        sessionStorage.setItem('bothwellDrivewaysFormSubmitted', 'true');
  ...
  const whyChooseUs = [
    {
      ...
      description: "Over 16 years creating distinguished driveways that enhance Bothwell's prestigious properties and reflect the area's upscale character."
    },
    {
      icon: <Shield className="w-6 h-6 text-primary-accent" />,
      title: "Luxury Materials & Finishes",
      description: "Premium natural stone, high-grade block paving, and meticulous finishing that meets Bothwell's exacting standards for quality."
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-primary-accent" />,
      title: "Property Value Enhancement",
      description: "Driveways designed to significantly enhance your Bothwell property's curb appeal and long-term investment value."
    },
    {
  ...
  const faqs = [
    {
      question: "What driveway materials suit Bothwell's prestigious properties?",
      answer: "For Bothwell's upscale homes, we recommend premium natural stone, high-grade block paving, or luxury concrete finishes. These materials provide exceptional durability while enhancing your property's distinguished character and neighborhood appeal."
    },
    {
    ...
    {
      question: "What's the typical investment for a Bothwell driveway?",
      answer: "Premium driveways in Bothwell typically range from £6,000-£15,000+ depending on size, materials, and complexity. We provide detailed quotes that reflect the quality and craftsmanship your property deserves."
    },
    {
    ...
    <div className="min-h-screen bg-primary-bg text-text-primary">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh] pt-16 sm:pt-8 lg:pt-0">
            ...
            <div className="text-left mt-20 sm:mt-12 lg:mt-0">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-normal mb-6 text-white leading-relaxed" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
                Luxury driveways & hardscaping that reflect Bothwell's prestigious character.
              </h2>
              ...
              <p className="text-lg sm:text-xl text-white mb-8 max-w-xl leading-relaxed font-light" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
                Creating distinguished entrances for discerning Bothwell homeowners with premium materials and expert craftsmanship.
              </p>
            ...
            <div className="hidden lg:block bg-black bg-opacity-60 backdrop-blur-sm rounded-xl p-8 border border-white border-opacity-10">
              ...
              <p className="text-gray-300 text-center mb-8">
                Tell us about your Bothwell driveway project
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <textarea
                    ...
                    placeholder="Tell us about your Bothwell driveway project..."
                  ></textarea>
                </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary-bg">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-6">
            Premium Driveway Installation in Bothwell
          </h2>
          <div className="space-y-6 text-lg sm:text-xl text-text-secondary leading-relaxed">
            <p>
              Bothwell's distinguished properties deserve driveways that reflect the area's prestigious character and enhance long-term property value. We create elegant entrances using premium materials and expert craftsmanship that complement your home's architectural distinction.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary-bg">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-secondary max-w-3xl mx-auto">
              See how we've transformed driveways with professional installation, premium materials, and expert craftsmanship.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-4">
              Driveway FAQs for Bothwell Residents
            </h2>
            <p className="text-lg text-text-secondary">
              Common questions about our premium driveway installation services for Bothwell properties.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-accent/10 to-hover-accent/10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-secondary-bg/80 backdrop-blur-sm border border-primary-accent/30 rounded-xl p-8 lg:p-12">
            <h2 className="font-heading text-3xl sm:text-4xl font-bold text-text-primary mb-6">
              Transform Your Bothwell Driveway Today
            </h2>
            <p className="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
              Ready to enhance your Bothwell property with a premium driveway? Get your free consultation today.
            </p>
            ...
            <div className="mt-8 pt-6 border-t border-border-color">
              <p className="text-text-secondary text-sm">
                <strong className="text-primary-accent">Serving Bothwell:</strong> Premium driveway services for South Lanarkshire's finest properties
              </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "HSC Builders - Driveway Services Bothwell",
            "description": "Premium driveway installation in Bothwell, South Lanarkshire. Luxury natural stone, block paving, and hardscaping for prestigious properties.",
            "url": "https://hscbuilders.co.uk/areas/bothwell-driveways",
            ...
            "serviceType": "Premium Driveway Installation",
            "priceRange": "£££",
            "aggregateRating": {
...
export default BothwellDriveways;